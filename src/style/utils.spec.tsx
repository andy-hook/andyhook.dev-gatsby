...
describe("uniformScale", () => {
  ...
  test("Should return correct value when supplied PX unit", () => {
    expect(uniformScale("10px", "topUltra")).toEqual("0.45454545454545453vw")
  })

  test("Should return correct value when supplied EM unit", () => {
    expect(uniformScale("10em", "topUltra")).toEqual("7.2727272727272725vw")
  })

  test("Should return correct value when supplied REM unit", () => {
    expect(uniformScale("10rem", "topUltra")).toEqual("7.2727272727272725vw")
  })
})
