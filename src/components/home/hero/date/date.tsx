    ...
    >
      <defs>
        <radialGradient
          ...
          id="radialGradient-1"
        >
          <stop stopColor="#4B4B50" offset="0%" />
          <stop stopColor="#313138" offset="22.0632378%" />
          <stop stopColor="#1A1A1F" offset="65.9662424%" />
          <stop stopColor="#070709" offset="100%" />
        </radialGradient>
        <path
        ...
        <radialGradient
          ...
          id="radialGradient-3"
        >
          <stop stopColor="#7F7F86" offset="0%" />
          <stop stopColor="#393941" offset="13.6973293%" />
          <stop stopColor="#1A1A1F" offset="52.7411259%" />
        ...
        <radialGradient
          ...
          id="radialGradient-5"
        >
          <stop stopColor="#45454B" offset="0%" />
          <stop stopColor="#242429" offset="30.9535333%" />
          <stop stopColor="#19191E" offset="59.2656712%" />
          <stop stopColor="#08080A" offset="100%" />
        </radialGradient>
        <polygon
          id="path-6"
        ...
        <radialGradient
          ...
          id="radialGradient-7"
        >
          <stop stopColor="#797981" offset="0%" />
          <stop stopColor="#36363E" offset="10.1951137%" />
          <stop stopColor="#141419" offset="54.6704616%" />
          <stop stopColor="#101014" offset="100%" />
        </radialGradient>
        <path
